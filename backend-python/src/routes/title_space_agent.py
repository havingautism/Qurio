"""
Title, space, and agent selection API routes.
"""
...
@router.post("/title-space-agent")
async def title_space_agent(request: Request) -> JSONResponse:
    ...
    result = await generate_title_space_and_agent(
        provider=provider,
