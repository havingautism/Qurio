...
def _build_html_deck_preview(slide_html_units: list[str], shared_styles: str = "") -> str:
    ...
    for raw_slide in slide_html_units[:max_pages]:
        ...
        srcdoc = (
            ...
            ".qurio-slide-root .swiper-pagination,.qurio-slide-root .swiper-button-prev,.qurio-slide-root .swiper-button-next{display:none!important;}"
            "</style>"
            + shared_styles
    ...
    return (
        ...
        ".qurio-ppt-toolbar{display:flex;align-items:center;justify-content:space-between;gap:8px;margin-bottom:8px;}"
        ".qurio-ppt-title{font-size:12px;opacity:.78;}"
        ...
        "<div class='qurio-ppt-title'>HTML Slides Preview</div>"
