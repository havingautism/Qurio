...
const InteractiveForm = ({
  ...
  return (
    <div className="mb-4 w-full max-w-2xl mx-1 relative z-30">
      <div className="p-6 md:p-8 rounded-[2rem] bg-white/80 dark:bg-black/40 backdrop-blur-xl border border-gray-200 dark:border-white/10 shadow-xl shadow-gray-200/50 dark:shadow-black/50 relative group transition-all duration-300">
