              ...
              <div className="flex flex-col gap-8 max-w-2xl">
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex flex-col gap-1">
                    <label className="text-sm font-medium text-gray-900 dark:text-white">Gemini API Key</label>
                    <p className="text-xs text-gray-500 dark:text-gray-400">Key used to access Google Gemini models.</p>
                  </div>
