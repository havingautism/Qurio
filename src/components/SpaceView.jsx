...
const SpaceView = ({ space, onEditSpace }) => {
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                            <h1 className="text-2xl font-semibold text-gray-900 dark:text-white">{space.label}</h1>
                    ...
                    <div className="flex flex-col gap-4">
                        {[1, 2, 3].map((_, i) => (
                            <div key={i} className="group cursor-pointer">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-gray-500 dark:text-gray-400 line-clamp-2 mt-1">
                                            This is a summary of the topic content. It might be a long description that gets truncated...
                                        </p>
                                ...
                                {i < 2 && <div className="h-px bg-gray-100 dark:bg-zinc-800 mt-4" />}
                            </div>
                        ))}
                    </div>
                </div>
