  ...
  return (
    ...
    >
      <button
        ...
        className="mb-4 flex w-full items-center justify-between gap-3 text-left text-gray-900 dark:text-gray-100"
      >
          ...
          {questions &&
            questions.map((question, index) => (
              <div
                ...
                className="bg-user-bubble border-primary-100/50 hover:bg-user-bubble group flex cursor-pointer items-center justify-between rounded-2xl border border px-3 py-2 transition-colors sm:hover:scale-102 dark:border-zinc-800/80 dark:bg-zinc-800/50 dark:hover:bg-zinc-800/50"
              >
                <span className="text-[13px] font-medium text-gray-700 md:text-balance dark:text-gray-300">
                  {question}
                </span>
