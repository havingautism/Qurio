          ...
          {questions &&
            questions.map((question, index) => (
              <div
                ...
                className="bg-user-bubble border-primary-100/50 hover:bg-user-bubble group flex cursor-pointer items-center justify-between rounded-lg border px-3 py-2 transition-colors sm:hover:scale-102 dark:border-zinc-800/80 dark:bg-zinc-800/50 dark:hover:bg-zinc-800/50"
              >
