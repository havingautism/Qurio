            ...
            <div className="mb-6 space-y-4 sm:mb-10">
              <div className="relative">
                ...
                <input
                  ...
                  className="focus:ring-primary-500/20 w-full rounded-2xl border-none bg-white py-3 pr-4 pl-12 text-sm text-gray-900 shadow-sm transition-all outline-none focus:ring-2 sm:py-3.5 dark:bg-zinc-900 dark:text-white"
                />
                {searchQuery && (
                  <button
